package com.xpw.chosedemo.view;
...
import com.xpw.chosedemo.pojo.Pointer;
...
//    private Bitmap bitmap = new BitmapFactory();
    ...
    public void choseRect(float startX, float startY, float endX, float endY,Paint paint) {
        canvas = getHolder().lockCanvas();
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction() & event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                preX = event.getX();
                preY = event.getY();
                pointerMap.get(0).setStartX(x);
                pointerMap.get(0).setStartY(y);
            ...
            case MotionEvent.ACTION_UP:
                ...
                y = event.getY();
                draw();
                choseRect(pointerMap.get(0).getStartX(),pointerMap.get(0).getStartY(),x,y,paint);
                break;
